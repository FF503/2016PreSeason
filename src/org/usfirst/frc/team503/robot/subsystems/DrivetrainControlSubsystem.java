 ...
 * @see Subsystem.java
 */
public class DrivetrainControlSubsystem extends Subsystem {
		    
    protected static final int kVelocityControlSlot = 0;
    protected static final int kBaseLockControlSlot = 1;

    private static DrivetrainControlSubsystem instance_ = new DrivetrainControlSubsystem();
    private double mLastHeadingErrorDegrees;

    public static DrivetrainControlSubsystem getInstance() {
        return instance_;
    }
...
//    private final ADXRS453_Gyro gyro_;
    ...
    // robot powers up
    private DrivetrainControlSubsystem() {
